  ...
  return (
    <div className="relative flex flex-col items-center justify-center h-full w-full overflow-hidden">
      ...
      {particles.map((p, i) => (
        <div key={i}
          ...
          style={{
            ...
            left: p.left,
            top: p.top,
            animation: `pulse-glow ${p.animDuration}s ease-in-out infinite`,
      ...
      <div className="relative z-10 flex flex-col items-center gap-8 px-6 text-center animate-fadeIn w-full" style={{ maxWidth: '480px' }}>
        ...
        <div>
          ...
          <p className="text-lg" style={{ color: '#64748b' }}>
            Build React apps with AI. Zero setup. Instant preview.
          </p>
        </div>
      ...
      <div className="absolute bottom-6 text-xs" style={{ color: '#334155' }}>
        DevForge • AI-Powered • Isolated Runtime • Zero Config
      </div>
    </div>
  )
}
